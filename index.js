...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.0idjzo0.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const paymentsCollection = client.db('doctors-portal').collection('payment')
  ...
  app.post('/payments', async (req, res) =>{
    ...
    app.delete("/doctors/:id", verifyAdmin, verifyJWT, async (req, res) => {
      const id = req.params.id;
      const filter = { _id: ObjectId(id) };
